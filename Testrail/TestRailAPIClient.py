...
class TestRailAPIClient(object):
    ...
    def _send_post(self, uri, data, headers=None):
        ...
        *Returns:* \n
        ...
        """
        url = self._url + uri
        response = post(url, headers=headers, json=data, auth=(self._user, self._password), verify=True)
    ...
    def add_result_for_case(self, run_id, case_id, test_result_fields):
        ...
        *Example:*\n
        ...
        self._send_post(uri, test_result_fields, headers=DEFAULT_TESTRAIL_HEADERS)
    ...
    def add_run(self, project_id, suite_id=None, name=None, description=None, milestone_id=None, assignedto_id=None,
                include_all=None, case_ids=None):
